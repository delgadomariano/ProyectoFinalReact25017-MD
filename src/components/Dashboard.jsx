...
const API_URL = 'https://6878255531d28a460e1d4ec9.mockapi.io/api/v1/products';

const Dashboard = () => {
 const [productos, setProductos] = useState([]);
  const [show, setShow] = useState(false);
  const [form, setForm] = useState({ title: '', description: '', category: '', price: '', stock: '', image: '' });
  ...
  const handleClose = () => {
    setShow(false);
    setForm({ title: '', description: '', category: '', price: '', stock: '', image: '' });
    setEditId(null);
  };
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-2">
             ...
             <Form.Group className="mb-2">
              <Form.Label>IdExterno</Form.Label>
              <Form.Control
                type="number"
                value={form.idExterno}
                onChange={e => setForm({ ...form, idExterno: Number(e.target.value) })}
                required
              />
            </Form.Group>
